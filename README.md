...
You have to design & build the backend for the application and the ability for the users to register, upload, view and share the files.
...
https://github.com/azaylamba/dropbox 
